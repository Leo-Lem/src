...
\begin{eexercises}{Minimale Spannbäume}{\input{res/prim.fig}}
...
\begin{solutions}
  ...
  \input{../../../../summaries/ad/res/graphs/bridges.alg}
...
\begin{eexercises}{Dijkstras Algorithmus}{\input{res/dijsktra.fig}}
